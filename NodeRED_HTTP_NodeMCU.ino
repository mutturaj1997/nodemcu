...
const char* ssid = "JioFiber-GJFCn";
...
void setup()
{
 ...
 server.on("/switch1", []() // http://localIPAddress/switch
  {
    int swstatus = digitalRead(SW1);
    Serial.println(swstatus);
    String swstusvalue = String(swstatus);

    server.send(200, "text/plain", swstusvalue);
  });
